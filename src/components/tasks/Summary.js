const Summary = () => {
  return (
    <div className="tasks-summary">
      <button className="tasks-summary__status tasks-summary__status--selected tasks__btn">
      ...
      <button className="tasks-summary__status tasks__btn">
        ...
        <span className="tasks-summary__number">25</span>
      </button>
      <button className="tasks-summary__status tasks__btn">
        <div className="tasks-summary__title">
        ...
        <span className="tasks-summary__number">57</span>
      </button>
    </div>
  )
}
