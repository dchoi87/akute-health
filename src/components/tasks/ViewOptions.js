...
const ViewOptions = ({handleViewOptions, viewOption}) => {
  return (
    <div className="tasks-view">
      <button
        className={"tasks-view__option tasks__btn" + (viewOption === 'comfortable' ? ' tasks__btn--selected' : '')}
      ...
      <button
        className={"tasks-view__option tasks__btn" + (viewOption === 'compact' ? ' tasks__btn--selected' : '')}
        onClick={handleViewOptions}
        data-id="compact"
        >
      ...
      <button
        className={"tasks-view__option tasks__btn" + (viewOption === 'grid' ? ' tasks__btn--selected' : '')}
        onClick={handleViewOptions}
        data-id="grid"
        >
